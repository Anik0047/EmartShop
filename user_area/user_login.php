    ...
    <div class="design">
        ...
        <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="custom pt-5">
                ...
                <div>
                    <input name="user_register" type="submit" class="btn btn-accent font-bold" value="Login">
                    <p class="font-bold pt-2">Already have an account? <a class="text-red-700 link" href="user_register.php">Registration</a>
                    </p>
                </div>
            </div>
        </form>
