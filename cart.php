...
<body>
    ...
    <!-- cart table -->
    <div class="overflow-x-auto mt-40 border border-black">
        <table class="table">
            <!-- head -->
            <thead>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <th>
                                <button class='px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg focus:outline-none hover:bounce-once'>Update</button>
                                <button class='px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg focus:outline-none hover:bounce-once'>Remove</button>
                            </th>
                        </tr>
                <?php
                    }
