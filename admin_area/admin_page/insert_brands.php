...
<form action="" method="post" class="mt-10 flex flex-col justify-center items-center">
    <input type="text" name="brands_title" placeholder="Enter Brands"
    ...
    <!-- <input
        ...
        type="submit"> -->
    <button
        class="text-lg font-bold rounded-lg  py-2 px-10 w-52 mt-5 bg-white hover:bg-orange-500 transition ease-in delay-150 hover:-translate-y-1 hover:ease-in-out hover:scale-110 duration-300">Submit</button>
</form>